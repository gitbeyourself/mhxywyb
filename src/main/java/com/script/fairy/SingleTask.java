    ...
    public void receive() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_5() throws Exception {
                ...
                result = mFairy.findPic(427,146,674,355,new String[]{"hang in the air.png","hang in the air2.png"});
                result1 = mFairy.findPic(397,143,671,352,"go therd.png");
                if (result.sim > 0.8f || result1.sim > 0.8f){
                    result = mFairy.findPic(584,41,720,162,"cha4.png");
                    mFairy.onTap(0.8f, result, "关闭", 2000);
                    if (result.sim > 0.8f) {
                        setTaskName(6);
                        return;
            ...
            public void content_6() throws Exception {
                ...
                result = mFairy.findPic(17,851,690,1028,"achievement.png");
                mFairy.onTap(0.8f, result, "成就", 2000);

                result = mFairy.findPic(43,222,673,772,"red.png");
                mFairy.onTap(0.8f, result, "成就", 2000);

                result1 = mFairy.findPic(237,49,493,120,new String[]{"cj.png","achievement3.png","achievement2.png","achievement2vip.png"});
                result2 = mFairy.findPic(28,874,679,992,"achievement.png");
                ...
                result = mFairy.findPic(18,712,693,1035,"cjqu.png");
...
//                }
            ...
            public void content_9() throws Exception{
                ...
                result = mFairy.findPic(441,843,692,1069,new String[]{"shengji.png","svipsgengji.png","bangpaishengji.png"});
                if (result.sim>0.8f){
                    mFairy.onTap(0.8f, result, "升级", 2000);
                    for (int i=0;i<=10;i++){
                        result = mFairy.findPic(131,326,591,771,new String[]{"bgbz.png"});
                        if (result.sim >= 0.8f){
                            gameUtil.close2();
                            setTaskName(1);return;
                        }
    ...
    public void sealDemon() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_1() throws Exception {
                ...
                result = mFairy.findPic(12,1034,171,1149,"svipfy.png");
                mFairy.onTap(0.8f, result, "封妖按钮", 2000);

                result = mFairy.findPic(233,55,503,124,new String[]{"sealDemon2.png","sealDemon2vip.png"});
            ...
            public void content_2() throws Exception {
                result = mFairy.findPic(503,237,674,769,"Seal.png");
                if(result.sim > 0.8f){
                    mFairy.onTap(0.8f, result, "前往封印", 2000);
                }else{
                    result = mFairy.findPic(503,237,674,769,new String[]{"Refresh.png","Refresh2.png"});
...
//                        setTaskEnd();return;
    ...
    public void guard() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_1() throws Exception {
                result1 = mFairy.findPic(81,528,239,785,new String[]{"tongmeng.png","gang.png"});
                mFairy.onTap(0.8f, result1, "帮派", 2000);
                result3 = mFairy.findPic(241,95,502,247,"bpshs.png");
                result2 = mFairy.findPic(81,796,247,1046,new String[]{"Animal room.png"});
                result = mFairy.findPic(213,44,519,129,new String[]{"bpxx.png"});
                ...
                result = mFairy.findPic(13,1032,709,1154,"bpdt.png");
                mFairy.onTap(0.8f, result, "帮派地图", 2000);

                result = mFairy.findPic(89,802,246,1050,new String[]{"Animal room.png"});
                if(result.sim > 0.8f){
                    mFairy.onTap(0.8f, result,result.x-90,result.y+45,result.x-100,result.y+50, "兽室", 1000);
                    for (int i=0;i<=15;i++){
                        result = mFairy.findPic(159,484,573,741,"bpss.png");
                        if(result.sim > 0.8f){
                            LtLog.e("未开启");
                            gameUtil.close();
                            setTaskEnd();return;
                ...
                result = mFairy.findPic(241,95,502,247,"bpshs.png");
                if(result.sim > 0.8f){
                    setTaskName(2);return;
                }
            }
            public void content_2() throws Exception {
                ...
                result = mFairy.findPic(380,881,685,1081,new String[]{"train one.png","vipxulian.png"});
                mFairy.onTap(0.8f, result, "训练一次", 2000);
