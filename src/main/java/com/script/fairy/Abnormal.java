...
public class Abnormal extends TaskContent {
    ...
    public void erro() throws Exception {
        ...
        result = mFairy.findPic(170,543,555,687,"gj.png");
        mFairy.onTap(0.8f, result, "挂机点击", 2000);

        result = mFairy.findPic(66,767,641,974,"Slide lock.png");
        if (result.sim > 0.8f) {
            LtLog.e(mFairy.getLineInfo("err解锁中"));
            mFairy.ranSwipe(146,883,605,874,500, (long) 500,0);
        }
